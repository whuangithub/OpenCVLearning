...
int main(int,char**)
{
		...
		// Accessing pixel intensity values
		{
				...
				int y = 0, x = 0;
				{
						...
						// Scalar: 4-element vector, widely used to pass pixel values
						// Mat::at returns a reference
		...
		// Memory management and reference counting
		{
				...
				//  developer has to make sure that lifetime of points is longer than of pointsMat
				//  If we need to copy the data, use cv::Mat::copyTo or cv::Mat::clone:
		...
		}
		{
				...
				Mat img = imread("image.jpg");
				Mat sobelx;
				// Sobel: some function to calculate the derivatives
				// data in sobelx will be lost
